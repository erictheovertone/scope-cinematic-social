...
export const CHANNELS: ChannelConfig[] = [
  { key: 'luma', label: 'LUMA', pro: false, xLabel: 'INPUT', yLabel: 'OUTPUT', neutral: 'diagonal', wrap: false, line: 'var(--ink-100)' },
  ...
  { key: 'hue',  label: 'HUE',  pro: true,  xLabel: 'HUE',   yLabel: 'SAT',    neutral: 'flat',     wrap: true,  line: 'var(--ink-100)' },
];
