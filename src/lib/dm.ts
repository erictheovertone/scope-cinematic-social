...
/** Compact relative time for inbox rows + thread time-breaks (now / 5m / 3h / 2d /
 *  Jan 4). Mirrors the notifications page's timeAgo language. */
export function dmTimeAgo(iso: string): string {
