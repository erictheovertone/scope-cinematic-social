...
export const DIVIDER_LINES: Record<DividerLineKey, DividerLine> = {
  ...
  sunset:  { key: 'sunset',  name: 'SUNSET',  gradient: 'linear-gradient(180deg, #D77BFF 0%, #E15CBF 33%, #E74C9D 50%, #EB3E80 66%, #F51F40 88%, var(--ink-100) 100%)', tier: 3 },
  burn:    { key: 'burn',    name: 'BURN',    gradient: 'linear-gradient(180deg, #FFF3EC 0%, #FFBB00 39%, var(--ink-100) 100%)', tier: 3 },
};
