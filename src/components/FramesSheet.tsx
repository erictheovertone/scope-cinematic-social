    ...
    <>
      ...
      >
        ...
        <div style={{ display: "flex", justifyContent: "center", paddingTop: 10, marginBottom: 4 }}>
          <div style={{ width: 36, height: 2, background: "rgb(var(--ink-rgb) / 0.12)" }} />
        </div>
        ...
        <div style={{ padding: "16px 20px 0", position: "relative" }}>
          <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between" }}>
            <div>
              <p style={{ ...SKB, fontSize: 'var(--fs-9)', letterSpacing: "0.15em", color: "rgb(var(--ink-rgb) / 0.4)", textTransform: "uppercase", margin: "0 0 4px" }}>
                FRAMES
              </p>
            ...
            >
              <span style={{ fontSize: 'var(--fs-18)', color: "rgb(var(--ink-rgb) / 0.5)", lineHeight: 1, display: "block" }}>×</span>
            </button>
          </div>
          ...
          <div style={{ marginTop: 12 }}>
            <span style={{
              ...
              color: count > 0 ? "var(--ink-100)" : "rgb(var(--ink-rgb) / 0.5)",
        ...
        {/* Divider */}
        <div style={{ height: 1, background: "rgb(var(--ink-rgb) / 0.08)", margin: "14px 0" }} />

        {/* Image picker grid */}
        <div style={{ padding: "0 4px" }}>
          {items.length === 0 ? (
            <p style={{ ...SKR, fontSize: 'var(--fs-11)', color: "rgb(var(--ink-rgb) / 0.4)", textAlign: "center", padding: "24px 0" }}>
        ...
        {/* Divider */}
        <div style={{ height: 1, background: "rgb(var(--ink-rgb) / 0.08)", margin: "16px 0" }} />
        ...
        <div style={{ padding: "8px 20px 0", textAlign: "center" }}>
          <p style={{ ...SKB, fontSize: 'var(--fs-8)', letterSpacing: "0.1em", color: "rgb(var(--ink-rgb) / 0.5)", textTransform: "uppercase", margin: 0 }}>
            {isOwnDeck
        ...
        {/* Error */}
        {exportError && (
          <p style={{ ...SKB, fontSize: 'var(--fs-9)', color: "var(--ink-100)", textAlign: "center", margin: "12px 0 0", letterSpacing: "0.06em" }}>
            {exportError}
          </p>
        )}
        ...
        {exporting && (
          ...
          >
            {exportDone ? (
              <p style={{ ...SKB, fontSize: 'var(--fs-10)', letterSpacing: "0.15em", color: "var(--ink-100)", textTransform: "uppercase" }}>
                EXPORTED ✓
              </p>
            ) : (
              <>
                <ScopeLoader size="md" />
                <p style={{ ...SKB, fontSize: 'var(--fs-10)', letterSpacing: "0.15em", color: "rgb(var(--ink-rgb) / 0.7)", textTransform: "uppercase", margin: 0 }}>
                  RENDERING FRAMES...
                </p>
              </>
            )}
