  ...
  return (
    <div className="su-scrim" data-swipe-exclude onClick={onClose} role="dialog" aria-modal="true">
      ...
      <style>{`
        ...
        .su-label{color:var(--ink-100);font-weight:700;font-size:10px;letter-spacing:.18em;text-transform:uppercase}
        .su-headline{color:var(--ink-100);font-weight:700;font-size:25px;line-height:1.05;letter-spacing:-.02em;text-transform:uppercase;margin:0 0 18px;animation:su-rise .3s ease both;animation-delay:.15s}
        .su-meter{margin-bottom:16px;animation:su-rise .3s ease both;animation-delay:.20s}
        .su-track{height:3px;background:rgb(var(--ink-rgb) / .12);position:relative;overflow:hidden}
        .su-fill{position:absolute;left:0;top:0;height:100%;width:0;background:var(--ink-100);animation:su-fill .55s cubic-bezier(.16,.84,.3,1) both;animation-delay:.30s}
        @keyframes su-fill{from{width:0}to{width:100%}}
        .su-count{margin-top:7px;color:rgb(var(--ink-rgb) / .45);font-weight:700;font-size:9px;letter-spacing:.14em;text-transform:uppercase}
        .su-body{color:rgb(var(--ink-rgb) / .70);font-weight:400;font-size:12px;line-height:1.5;letter-spacing:-.01em;margin:0 0 20px;animation:su-rise .3s ease both;animation-delay:.24s}
        .su-divider{height:1px;background:rgb(var(--ink-rgb) / .12);margin-bottom:16px;animation:su-rise .3s ease both;animation-delay:.27s}
        .su-features{list-style:none;margin:0 0 22px;padding:0}
        .su-features li{display:flex;align-items:center;gap:9px;padding:5px 0;color:rgb(var(--ink-rgb) / .70);font-weight:700;font-size:10px;letter-spacing:.06em;text-transform:uppercase;animation:su-rise .3s ease both}
