...
const INPUT: React.CSSProperties = { ...SKB, fontSize: 13, color: 'var(--ink-100)', background: 'rgb(var(--ink-rgb) / 0.04)', border: `1px solid ${HAIR}`, outline: 'none', padding: '10px 12px', width: '100%', boxSizing: 'border-box', letterSpacing: '0.02em' };
  ...
  return (
    <div className="bg-canvas" style={{ position: 'fixed', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ position: 'relative', width: 820, minHeight: 520, background: 'var(--surface-1)', border: '1px solid var(--surface-3)', boxSizing: 'border-box', padding: '54px 60px' }}>
        ...
        <p style={{ ...SKB, fontWeight: 400, fontSize: 13, color: 'rgb(var(--ink-rgb) / 0.6)', margin: '0 0 30px' }}>This is how the world sees you on Scope.</p>
