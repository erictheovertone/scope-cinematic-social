        ...
        {step === 'commit' && (
          <div style={{ marginTop: 48 }}>
            ...
            <button
              onClick={confirm}
              disabled={saving}
              style={{ ...SKB, fontSize: 13, color: '#000', textTransform: 'uppercase', letterSpacing: '0.12em', background: 'var(--ink-100)', border: 'none', cursor: 'pointer', padding: '14px 54px', marginTop: 22, opacity: saving ? 0.6 : 1 }}
            >
