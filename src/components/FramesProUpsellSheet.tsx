    ...
    <>
      ...
      <div
        style={{
          ...
          padding: "0 20px calc(28px + var(--safe-bottom))", /* X3 §3 — bottom sheet: clear the home indicator */
        }}
      >
        {/* Drag handle */}
        <div style={{ display: "flex", justifyContent: "center", paddingTop: 20, marginBottom: 4 }}>
          <div style={{ width: 36, height: 3, background: "rgb(var(--ink-rgb) / 0.2)" }} />
        </div>
        ...
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", paddingTop: 16 }}>
          <div>
            ...
            <p style={{ ...SKR, fontSize: 'var(--fs-13)', lineHeight: 1.5, color: "rgb(var(--ink-rgb) / 0.85)", margin: 0, maxWidth: 260 }}>
          ...
          >
            <svg width="21.5" height="21.5" viewBox="0 0 18 18" fill="none">
              <path d="M3 3L15 15M15 3L3 15" stroke="rgb(var(--ink-rgb) / 0.5)" strokeWidth="1.5" strokeLinecap="round" />
            </svg>
          </button>
        </div>
            ...
            <div style={{ position: "absolute", width: 70 }}>
              {[0, 1, 2].map(i => (
                <div
                  ...
                  style={{
                    height: 28,
                    background: `rgb(var(--ink-rgb) / ${0.04 + i * 0.03})`,
                    marginBottom: 2,
                  }}
                />
              ))}
        ...
        {/* What you get */}
        <p style={{ ...SKB, fontSize: 'var(--fs-9)', letterSpacing: "0.15em", color: "rgb(var(--ink-rgb) / 0.4)", textTransform: "uppercase", margin: "0 0 12px" }}>
          WHAT YOU GET
        </p>
        <div style={{ marginBottom: 20 }}>
          {[
            ...
            <p
              key={i}
              style={{ ...SKR, fontSize: 'var(--fs-12)', lineHeight: 1.5, color: "rgb(var(--ink-rgb) / 0.7)", margin: i < 2 ? "0 0 12px" : 0 }}
            >
              {line}
            </p>
          ))}
