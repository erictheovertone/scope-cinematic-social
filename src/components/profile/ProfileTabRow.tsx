  ...
  return (
    <div key={snapAnimKey} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 8px", height: 20 }}>
      ...
      {(headerSnapped || headerUnsnapping) ? (
        ...
        >
          <span style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 13.5, letterSpacing: "var(--track-display)", color: activeTab === "main" ? "var(--ink-100)" : "rgb(var(--ink-rgb) / 0.57)", textTransform: "uppercase" }}>MAIN</span>
        </button>
      )}
      ...
      >
        <span style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 13.5, letterSpacing: "var(--track-display)", color: activeTab === "collected" ? "var(--ink-100)" : "rgb(var(--ink-rgb) / 0.57)", textTransform: "uppercase" }}>COLLECTED</span>
      </button>
      ...
      >
        <span style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 13.5, letterSpacing: "var(--track-display)", color: activeTab === "decks" ? "var(--ink-100)" : "rgb(var(--ink-rgb) / 0.57)", textTransform: "uppercase" }}>DECKS</span>
      </button>
    </div>
  );
}
