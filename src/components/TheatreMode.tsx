      ...
      >
        ...
        {!showData && index > 0 && (
          ...
          >
            ...
            <img src="/theatre-mode-arrow-01.png" alt="Previous" style={{ height: arrowH, width: 'auto', display: 'block', transform: 'scaleX(-1)', filter: isDesktopVp ? 'brightness(1.3) drop-shadow(0 0 6px rgba(255,255,255,0.55))' : 'brightness(1.2)' }} />
          </button>
        )}
        {!showData && index < posts.length - 1 && (
          ...
          >
            <img src="/theatre-mode-arrow-01.png" alt="Next" style={{ height: arrowH, width: 'auto', display: 'block', filter: isDesktopVp ? 'brightness(1.3) drop-shadow(0 0 6px rgba(255,255,255,0.55))' : 'brightness(1.2)' }} />
          </button>
        )}
            ...
            {isFeed && (
              <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                ...
                <button onClick={(e) => { stop(e); handleLike(); }} aria-label="Like" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 4, background: 'transparent', border: 'none', cursor: 'pointer', minWidth: 44, minHeight: 44, padding: 0 }}>
                  <svg width="20.5" height="20.5" viewBox="0 0 24 24" fill={isLiked ? '#FF0000' : 'none'} stroke={isLiked ? '#FF0000' : 'rgba(255,255,255,0.85)'} strokeWidth="2" strokeLinejoin="round"><path d="M12 21s-7-4.5-9.5-9C1 9 2.5 5.5 6 5.5c2 0 3.2 1.2 4 2.3.8-1.1 2-2.3 4-2.3 3.5 0 5 3.5 3.5 6.5C19 16.5 12 21 12 21z"/></svg>
                ...
                <button onClick={(e) => { stop(e); setShowData(true); setShowComments(true); }} aria-label="Comments" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 4, background: 'transparent', border: 'none', cursor: 'pointer', minWidth: 44, minHeight: 44, padding: 0 }}>
                  <svg width="20.5" height="20.5" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.85)" strokeWidth="2" strokeLinejoin="round"><path d="M21 11.5a8.5 8.5 0 0 1-12.5 7.5L3 21l2-5.5A8.5 8.5 0 1 1 21 11.5z"/></svg>
