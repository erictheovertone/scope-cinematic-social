      ...
      <div style={{ display: 'flex', justifyContent: 'space-between' }}>
        {GRAIN_GAUGES.map((g) => {
          ...
          return (
            ...
            >
              <span style={{ ...SKB, fontSize: 'var(--fs-10)', color: on ? 'var(--ink-100)' : 'rgb(var(--ink-rgb) / 0.4)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>{g}</span>
          ...
          return (
            ...
            >
              <div style={{
                ...
                border: `1px solid ${on ? RED : 'rgb(var(--ink-rgb) / 0.18)'}`,
              }}>
                <img
                  src={s.file}
              ...
              <span style={{ ...SKB, fontSize: 'var(--fs-7)', color: on ? RED : 'rgb(var(--ink-rgb) / 0.5)', textTransform: 'uppercase', letterSpacing: '0.08em', whiteSpace: 'nowrap' }}>{s.density}</span>
            </button>
          );
        })}
      </div>
