        ...
        return (
          <button
            ...
            style={{
              ...
              color: on ? RED : 'rgb(var(--ink-rgb) / 0.5)', // drives the icon (currentColor)
            }}
          >
            ...
            <span style={{ ...SKB, fontSize: compact ? 7 : 9, color: on ? 'var(--ink-100)' : 'rgb(var(--ink-rgb) / 0.45)', textTransform: 'uppercase', letterSpacing: '0.06em' }}>{m.label}</span>
          </button>
        );
      })}
    </div>
