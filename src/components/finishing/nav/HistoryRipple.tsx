          ...
          >
            ...
            {row.kind === 'origin' ? (
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <span style={{ ...SKB, fontSize: 9, color: 'rgba(255,255,255,0.45)', textTransform: 'uppercase', letterSpacing: '0.1em' }}>ORIGINAL</span>
              </div>
            ) : (
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, minWidth: 0 }}>
                ...
                <span style={{ ...SKB, fontSize: 9, color: current ? RED : 'white', textTransform: 'uppercase', letterSpacing: '0.06em', whiteSpace: 'nowrap' }}>{row.e.label}</span>
                <span style={{ ...SKB, fontSize: 9, color: 'rgba(255,255,255,0.4)', letterSpacing: '0.04em', whiteSpace: 'nowrap', fontVariantNumeric: 'tabular-nums' }}>{row.e.value}</span>
              </div>
            )}
          </div>
        );
