  ...
  return (
    ...
    >
      ...
      {isUntradeableCoin(post) && (
        <div style={{ position: 'absolute', bottom: 6, left: 6, zIndex: 6, pointerEvents: 'none', background: 'rgba(0,0,0,0.72)', border: '1px solid rgb(var(--ink-rgb) / 0.5)', padding: '2px 5px' }}>
