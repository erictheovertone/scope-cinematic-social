    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 20 }}>
          <div style={{ width: 36, height: 3, backgroundColor: 'rgba(229,225,219,0.2)' }} />
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 20 }}>
          ...
          />
          <div>
            <p style={{ ...SKB, fontSize: 'var(--fs-9)', color: 'rgba(229,225,219,0.4)', letterSpacing: '0.15em', textTransform: 'uppercase', margin: '0 0 4px' }}>
              INSTALL
            </p>
            <p style={{ ...SKB, fontSize: 'var(--fs-16)', color: '#E5E1DB', letterSpacing: '0.02em', textTransform: 'uppercase', margin: 0 }}>
              SCOPE
            </p>
          </div>
        </div>
        ...
        {/* Description */}
        <p style={{ ...SKR, fontSize: 'var(--fs-12)', color: 'rgba(229,225,219,0.7)', lineHeight: 1.5, margin: '0 0 28px' }}>
          {plt === 'android-chrome'
            ...
            {[
              {
                ...
                icon: (
                  <svg width="23.5" height="29.5" viewBox="0 0 16 20" fill="none">
                    <path d="M8 1 L8 13" stroke="#E5E1DB" strokeWidth="1.5"/>
                    <path d="M4 5 L8 1 L12 5" stroke="#E5E1DB" strokeWidth="1.5" fill="none"/>
                    <path d="M2 8 L2 18 L14 18 L14 8" stroke="#E5E1DB" strokeWidth="1.5" fill="none"/>
                  </svg>
                ),
              },
              {
                ...
                icon: (
                  <svg width="23.5" height="23.5" viewBox="0 0 16 16" fill="none">
                    <rect x="1" y="1" width="14" height="14" stroke="#E5E1DB" strokeWidth="1.5" fill="none"/>
                    <path d="M8 4 L8 12 M4 8 L12 8" stroke="#E5E1DB" strokeWidth="1.5"/>
                  </svg>
                ),
              },
            ].map((row, i) => (
              ...
              >
                <span style={{ ...SKB, fontSize: 'var(--fs-28)', color: '#E5E1DB', letterSpacing: '0.02em', lineHeight: 1, minWidth: 36 }}>
                  {row.num}
                </span>
                <div style={{ flex: 1 }}>
                  <p style={{ ...SKB, fontSize: 'var(--fs-11)', color: '#E5E1DB', letterSpacing: '0.1em', textTransform: 'uppercase', lineHeight: 1.4, margin: '0 0 4px' }}>
                    {row.label}
                  </p>
                  <p style={{ ...SKR, fontSize: 'var(--fs-11)', color: 'rgba(229,225,219,0.5)', lineHeight: 1.4, margin: 0 }}>
                    {row.subtitle}
                  </p>
                </div>
        ...
        {plt === 'ios-chrome' && (
          <div style={{ marginBottom: 28 }}>
            <p style={{ ...SKB, fontSize: 'var(--fs-11)', color: '#E5E1DB', letterSpacing: '0.1em', textTransform: 'uppercase', lineHeight: 1.4, margin: '0 0 8px' }}>
