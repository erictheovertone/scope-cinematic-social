  ...
  return (
    <>
      ...
      >
        ...
        <p style={{ ...SKB, fontSize: 'var(--fs-11)', color: 'var(--ink-100)', textTransform: 'uppercase', letterSpacing: '0.06em', margin: '0 0 8px' }}>
          Not yet collectible
        </p>
        <p style={{ ...SKR, fontSize: 'var(--fs-10)', color: 'rgb(var(--ink-rgb) / 0.55)', lineHeight: 1.5, margin: '0 0 22px' }}>
          This post hasn&rsquo;t been minted, so there&rsquo;s nothing to collect yet.
        </p>
        <button
          onClick={onClose}
          className="press-row"
          style={{ ...SKB, width: '100%', fontSize: 'var(--fs-10)', color: 'var(--ink-100)', textTransform: 'uppercase', letterSpacing: '0.08em', background: 'transparent', border: '1px solid rgb(var(--ink-rgb) / 0.2)', cursor: 'pointer', padding: '13px 0', touchAction: 'manipulation' }}
        >
          Got it
        </button>
      </div>
