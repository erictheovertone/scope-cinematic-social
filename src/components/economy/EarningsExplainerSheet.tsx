      ...
      >
        ...
        {BEATS.map((b) => (
          <div key={b.lead} style={{ marginBottom: 22 }}>
            <p style={{ ...SKB, fontSize: 'var(--fs-13)', color: 'var(--ink-100)', margin: '0 0 5px', letterSpacing: '-0.01em' }}>
              {b.lead}
            </p>
            <p style={{ ...SKR, fontSize: 'var(--fs-11)', color: 'rgb(var(--ink-rgb) / 0.55)', lineHeight: 1.6, margin: 0 }}>
              {b.body}
            </p>
          </div>
        ))}
