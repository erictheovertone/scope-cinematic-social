...
// never blocks or replaces it. On-brand: pure black scrim, var(--ink-100), SK-Modernist,
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          background: 'radial-gradient(circle, rgb(var(--ink-rgb) / 0.55) 0%, rgb(var(--ink-rgb) / 0.28) 28%, rgb(var(--ink-rgb) / 0.08) 50%, rgb(var(--ink-rgb) / 0) 70%)',
      ...
      <div style={{ position: 'relative', width: 96, height: 96, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <div
          ...
          style={{
            ...
            border: '1.5px solid var(--ink-100)', borderRadius: '50%',
        ...
        <img
          ...
          style={{
            ...
            filter: 'drop-shadow(0 0 12px rgb(var(--ink-rgb) / 0.55))',
      ...
      <div
        className="fc-label"
        style={{ ...SKB, marginTop: 18, fontSize: 'var(--fs-15)', letterSpacing: '0.24em', color: 'var(--ink-100)', textTransform: 'uppercase', animation: `fcLabel ${DUR} ease both` }}
      >
        First Cut
      </div>
      {rank != null && (
        <div
          className="fc-label"
          style={{ ...SKB, marginTop: 6, fontSize: 'var(--fs-8)', letterSpacing: '0.3em', color: 'var(--ink-100)', textTransform: 'uppercase', animation: `fcLabel ${DUR} ease both`, animationDelay: '0.08s' }}
        >
          Founding Nº {rank}
        </div>
      )}
