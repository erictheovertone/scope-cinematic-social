      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 10 }}>
            ...
            <span style={{ ...SKB, fontSize: 'var(--fs-8)', color: 'rgb(var(--ink-rgb) / 0.35)', textTransform: 'uppercase', letterSpacing: '0.16em' }}>ALL TIME</span>
          </div>
          {!empty && (
        ...
        >
          {empty ? (
            <p style={{ ...SKR, fontSize: 'var(--fs-11)', color: 'rgb(var(--ink-rgb) / 0.5)', textAlign: 'center', lineHeight: 1.6, margin: '26px 8px' }}>
            ...
            <>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 6, padding: '0 2px' }}>
                <span style={{ ...SKB, fontSize: 'var(--fs-7)', color: 'rgb(var(--ink-rgb) / 0.3)', letterSpacing: '0.14em', textTransform: 'uppercase' }}>{leftLabel}</span>
                <span style={{ ...SKB, fontSize: 'var(--fs-7)', color: 'rgb(var(--ink-rgb) / 0.3)', letterSpacing: '0.14em', textTransform: 'uppercase' }}>TODAY</span>
              </div>
            </>
          )}
        </motion.div>
        ...
        {/* Footnote */}
        <p style={{ ...SKR, fontSize: 'var(--fs-8)', color: 'rgb(var(--ink-rgb) / 0.28)', lineHeight: 1.6, margin: '16px 0 0', textTransform: 'uppercase', letterSpacing: '0.08em' }}>
        ...
        <button
          ...
          style={{
            ...
            fontSize: 'var(--fs-9)', color: 'rgb(var(--ink-rgb) / 0.65)', textTransform: 'uppercase', letterSpacing: '0.16em',
