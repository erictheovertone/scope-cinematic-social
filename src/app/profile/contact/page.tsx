        ...
        {submitted ? (
          <div className="flex flex-col items-center justify-center h-full">
            <div className="w-16 h-16 bg-green-600 rounded-full flex items-center justify-center mb-6">
              <svg width="27.5" height="27.5" viewBox="0 0 24 24" fill="none" stroke="var(--ink-100)" strokeWidth="2">
          ...
          <>
            ...
            <div className="mb-8">
              <h2 className="font-['IBM_Plex_Mono'] font-medium text-[var(--ink-100)] text-[var(--fs-16)] mb-4">
                Quick Help
              </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label className="font-['IBM_Plex_Mono'] font-medium text-[var(--ink-100)] text-[var(--fs-14)] block mb-2">
                  Email
                </label>
                <input
                  type="email"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  className="w-full bg-[#1A1A1A] border border-[#333333] rounded-lg px-4 py-3 font-['IBM_Plex_Mono'] text-[var(--ink-100)] text-[var(--fs-14)] resize-none focus:border-[var(--ink-100)] focus:outline-none"
              ...
              <button
                type="submit"
                className="w-full bg-[var(--ink-100)] text-[var(--on-ink)] py-4 rounded-lg font-['IBM_Plex_Mono'] font-medium text-[var(--fs-16)] hover:bg-[#d6d2cb] transition-colors"
              >
                Send Message
              </button>
            </form>
