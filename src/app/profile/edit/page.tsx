...
export default function EditProfilePage() {
  ...
  return (
    <div className="bg-canvas" style={{ position: 'fixed', inset: 0, overflowY: 'auto' }}>
      ...
      {isDirty && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 200, background: 'var(--canvas)', borderBottom: '1px solid rgb(var(--ink-rgb) / 0.15)', padding: 'calc(10px + var(--safe-top)) 20px 10px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
      ...
      <div style={{ maxWidth: '30rem', margin: '0 auto', paddingTop: `calc(${isDirty ? 44 : 0}px + var(--safe-top))`, paddingLeft: 20, paddingRight: 20, paddingBottom: 'calc(60px + var(--safe-bottom))' }}>
        ...
        {lineFlags.isFoundingMember && (
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginTop: 18 }}>
            <div style={{ width: 20, height: 60, position: 'relative', overflow: 'hidden', border: '1px solid rgb(var(--ink-rgb) / 0.18)', boxSizing: 'border-box', background: 'var(--canvas)', flexShrink: 0 }}>
              {holoBanner && (
