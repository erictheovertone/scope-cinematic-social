...
export default function HiddenPosts() {
  ...
  return (
    <div className="bg-black relative w-[375px] h-[812px] mx-auto">
      ...
      <div className="flex-1 overflow-y-auto">
        {hiddenPosts.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full px-6">
            <svg width="67.5" height="67.5" viewBox="0 0 24 24" fill="none" stroke="var(--mute-1)" strokeWidth="1">
              <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/>
              <circle cx="12" cy="12" r="3"/>
              <path d="M3 3l18 18"/>
            </svg>
            <p className="font-['IBM_Plex_Mono'] font-medium text-[var(--mute-2)] text-[var(--fs-16)] mt-4 text-center">
              No hidden posts
            </p>
            <p className="font-['IBM_Plex_Mono'] font-normal text-[var(--mute-2)] text-[var(--fs-12)] mt-2 text-center">
          ...
          <div className="px-4 py-4">
            {hiddenPosts.map((post) => (
              <div
                key={post.id}
                className="bg-[var(--surface-3)] border border-[var(--mute-1)] rounded-lg p-4 mb-4"
              >
                <div className="flex items-start space-x-4">
                  <div className="w-16 h-16 bg-[var(--mute-1)] rounded-lg flex-shrink-0 flex items-center justify-center">
                    <svg width="27.5" height="27.5" viewBox="0 0 24 24" fill="none" stroke="var(--mute-2)" strokeWidth="1.5">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-4 mb-3">
                      <p className="font-['IBM_Plex_Mono'] font-normal text-[var(--mute-2)] text-[var(--fs-11)]">
      ...
      {/* Info */}
      <div className="border-t border-[var(--mute-1)] p-6">
        <div className="bg-[var(--surface-3)] border border-[var(--mute-1)] rounded-lg p-4">
          <p className="font-['IBM_Plex_Mono'] font-medium text-[var(--ink-100)] text-[var(--fs-12)] mb-2">
            About Hidden Posts:
          </p>
          <ul className="space-y-1">
            <li className="font-['IBM_Plex_Mono'] font-normal text-[var(--mute-3)] text-[var(--fs-11)] flex items-start">
