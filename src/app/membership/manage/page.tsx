  ...
  if (cancelled) {
    return (
      <div style={{ backgroundColor: '#000', minHeight: '100dvh', padding: '48px 24px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
        <p style={{ ...SKB, fontSize: 'var(--fs-18)', color: 'white', textTransform: 'uppercase', textAlign: 'center', margin: '0 0 12px' }}>MEMBERSHIP CANCELLED</p>
        <p style={{ ...SKR, fontSize: 'var(--fs-12)', color: 'rgba(255,255,255,0.5)', textAlign: 'center', margin: '0 0 32px', lineHeight: 1.6 }}>
        ...
        <button onClick={() => router.push('/profile')} style={{ background: '#FF0000', border: 'none', cursor: 'pointer', padding: '12px 32px' }}>
          <span style={{ ...SKB, fontSize: 'var(--fs-11)', color: 'white', textTransform: 'uppercase', letterSpacing: '0.08em' }}>BACK TO PROFILE</span>
        </button>
      </div>
    );
  }
  ...
  return (
    <div style={{ backgroundColor: '#000', minHeight: '100dvh', padding: '0 0 80px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', padding: '16px', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
        ...
        <span style={{ ...SKB, fontSize: 'var(--fs-11)', color: 'white', textTransform: 'uppercase', letterSpacing: '0.05em' }}>MANAGE MEMBERSHIP</span>
      </div>
      ...
      <div style={{ padding: '24px 16px', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
          ...
          <div>
            <p style={{ ...SKB, fontSize: 'var(--fs-9)', color: 'rgba(255,255,255,0.4)', textTransform: 'uppercase', letterSpacing: '0.1em', margin: '0 0 4px' }}>CURRENT PLAN</p>
            <p style={{ ...SKB, fontSize: 'var(--fs-18)', color: 'white', textTransform: 'uppercase', margin: 0 }}>SCOPE PRO</p>
          </div>
        </div>
        <div style={{ display: 'flex', gap: 24 }}>
          {[
            ...
            <div key={label}>
              ...
              <p style={{ ...SKB, fontSize: 'var(--fs-12)', color: 'white', margin: 0 }}>{value}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      {/* What you get */}
      <div style={{ padding: '24px 16px', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
        <p style={{ ...SKB, fontSize: 'var(--fs-9)', color: 'rgba(255,255,255,0.4)', textTransform: 'uppercase', letterSpacing: '0.1em', margin: '0 0 16px' }}>INCLUDED WITH PRO</p>
        {[
          'Unlimited posts',
          ...
          <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
            ...
            <p style={{ ...SKR, fontSize: 'var(--fs-12)', color: 'rgba(255,255,255,0.7)', margin: 0 }}>{item}</p>
          </div>
        ))}
      </div>
      ...
      <div style={{ padding: '24px 16px' }}>
        {!showCancelConfirm ? (
          ...
          >
            <span style={{ ...SKB, fontSize: 'var(--fs-10)', color: 'rgba(255,255,255,0.4)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>CANCEL MEMBERSHIP</span>
          </button>
        ) : (
          <div style={{ border: '1px solid rgba(255,0,0,0.3)', padding: 20 }}>
            <p style={{ ...SKB, fontSize: 'var(--fs-13)', color: 'white', textTransform: 'uppercase', margin: '0 0 8px' }}>ARE YOU SURE?</p>
            <p style={{ ...SKR, fontSize: 'var(--fs-12)', color: 'rgba(255,255,255,0.5)', lineHeight: 1.6, margin: '0 0 20px' }}>
            ...
            <div style={{ display: 'flex', gap: 10 }}>
              ...
              >
                <span style={{ ...SKB, fontSize: 'var(--fs-10)', color: 'rgba(255,255,255,0.6)', textTransform: 'uppercase' }}>KEEP PRO</span>
              </button>
              <button
              ...
              >
                <span style={{ ...SKB, fontSize: 'var(--fs-10)', color: '#FF0000', textTransform: 'uppercase' }}>
