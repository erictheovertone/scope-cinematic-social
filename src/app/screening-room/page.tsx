...
function MobileScreeningRoom() {
  ...
  return (
    <>
    <div className="screen-min" style={{ minHeight: '100dvh', background: 'var(--canvas)', maxWidth: '30rem', margin: '0 auto', position: 'relative' }}>
          ...
          {rows.map((r) => {
            ...
            const rankChip = (
              <div style={{ position: 'absolute', top: 0, left: 0, background: 'var(--ink-100)', padding: '2px 7px', zIndex: 10 }}>
                <span style={{ ...SKB, fontSize: 'var(--fs-11)', color: 'var(--canvas)', letterSpacing: '0.04em' }}>{r.rank}</span>
              </div>
            );
            return (
              <div
